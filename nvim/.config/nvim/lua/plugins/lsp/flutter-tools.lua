local local_lsp = require("plugins.lsp")
-- Flutter Tools Setup
require("flutter-tools").setup({
	...
	lsp = {
		...
		on_attach = function(client, bufnr)
			...
			vim.keymap.set("n", "<leader>fd", "<Cmd>FlutterDevices<CR>", { desc = "flutter: devices", buffer = bufnr })
			vim.keymap.set(
				"n",
				"<leader>fe",
			...
			vim.keymap.set("n", "<leader>fr", "<Cmd>FlutterRun<CR>", { desc = "flutter: server run", buffer = bufnr })
			vim.keymap.set(
				"n",
				"<leader>frs",
